        ...
        <div className="py-12 md:py-20">
          ...
          <div className="mx-auto max-w-3xl pb-16 text-center md:pb-20">
            <h2 className="text-3xl font-bold text-gray-200 md:text-4xl">
              Enhancing the Accessibility of Blockchain Exploration
            </h2>
          </div>
          {/* Planet */}
          ...
          <div className="grid overflow-hidden sm:grid-cols-2 lg:grid-cols-3 [&>*]:relative [&>*]:p-6 [&>*]:before:absolute [&>*]:before:bg-gray-800 [&>*]:before:[block-size:100vh] [&>*]:before:[inline-size:1px] [&>*]:before:[inset-block-start:0] [&>*]:before:[inset-inline-start:-1px] [&>*]:after:absolute [&>*]:after:bg-gray-800 [&>*]:after:[block-size:1px] [&>*]:after:[inline-size:100vw] [&>*]:after:[inset-block-start:-1px] [&>*]:after:[inset-inline-start:0] md:[&>*]:p-10">
            <article>
              <h3 className="mb-2 flex items-center space-x-2 font-medium text-gray-200">
                <MemoryOutlinedIcon className="text-blue-500"></MemoryOutlinedIcon>
                <span>Burrito Node</span>
              </h3>
              <p className="text-[15px] text-gray-400">
                High-security, non-custodial validator on the Terra Classic
                blockchain, dedicated to maintaining high uptime and ensuring
            ...
            <article>
              <h3 className="mb-2 flex items-center space-x-2 font-medium text-gray-200">
                ...
                <SchoolOutlinedIcon className="text-blue-500"></SchoolOutlinedIcon>
                <span>Burrito College</span>
              </h3>
              <p className="text-[15px] text-gray-400">
                Your premier source for blockchain knowledge and technical
                insights. Stay updated with the latest trends, tutorials, and
                analyses.
              </p>
            </article>
            <article>
              <h3 className="mb-2 flex items-center space-x-2 font-medium text-gray-200">
                ...
                <MonitorHeartOutlinedIcon className="text-blue-500"></MonitorHeartOutlinedIcon>
            ...
            <article>
              <h3 className="mb-2 flex items-center space-x-2 font-medium text-gray-200">
                ...
                <span>Burrito Bridge</span>
              </h3>
              <p className="text-[15px] text-gray-400">
                A robust blockchain bridge enabling seamless wrapping and
            ...
            <article>
              <h3 className="mb-2 flex items-center space-x-2 font-medium text-gray-200">
                ...
                <CurrencyExchangeOutlinedIcon className="text-blue-500"></CurrencyExchangeOutlinedIcon>
                <span>Burrito Swap</span>
              </h3>
              <p className="text-[15px] text-gray-400">
                A versatile trading module enabling seamless token swaps and
                decentralized trading, allowing you to trade tokens effortlessly
            ...
            <article>
              ...
              <p className="text-[15px] text-gray-400">
                There will be more module coming soon...
              </p>
            </article>
          </div>
        </div>
